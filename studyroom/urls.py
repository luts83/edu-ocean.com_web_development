...
urlpatterns = (
    ...
    path('study_room/<int:pk>/create_comment/<str:username>/', views.create_comment, name='create_comment'),
    ...
    path('change-url/<int:pk>/', views.change_youtube_url, name='change_youtube_url'),
    path('edit_comment/<int:pk>/<int:studyroom_pk>/', views.CommentUpdate.as_view()),
